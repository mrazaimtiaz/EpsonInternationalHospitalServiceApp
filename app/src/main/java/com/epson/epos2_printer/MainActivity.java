...
public class MainActivity extends Activity implements ReceiveListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.mToolbarMain).setOnClickListener(
       ...
       //     button.setOnClickListener(this);
        ...
        Button mbtn = findViewById(R.id.myBtn);
  if (connectPrinter()) {
        ...
        mbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(mContext, DiscoveryActivity.class);
...
//            mPrinter.connect(mEditTarget.getText().toString(), Printer.PARAM_DEFAULT);
    ...
    public void onPtrReceive(final Printer printerObj, final int code, final PrinterStatusInfo status, final String printJobId) {
        runOnUiThread(new Runnable() {
            @Override
            public synchronized void run() {
                android.util.Log.d("TAG", "run: called printerobj");
    ...
    private String  getAddressNamePreference(){
        SharedPreferences pref = getApplicationContext().getSharedPreferences(
                Constants.BLUETOOTH_AUTH,
                0
        ) ;// 0 - for private mode

        return pref.getString(Constants.BLUETOOTH_NAME, "-999");
